...
public class PreferencesResetAlertFragment extends DialogFragment {
    ...
    public AlertDialog onCreateDialog(Bundle savedInstanceState) {
        ...
        alertDialogBuilder.setTitle(R.string.alert_reset_preferences).setMessage(R.string.alert_reset_preferences_warning)
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            mListener = (PreferencesResetDialogListener) activity;
